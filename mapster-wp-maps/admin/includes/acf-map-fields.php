	...
	This service uses <a href="https://ip-api.com/" target="_blank">IP-API.com</a>, which is not to be used on any commercial website unless you purchase a license. It has a number of technical restrictions as well. Please contact Mapster if you need more from this.',
		...
		modal_size = "sm" OR "lg"',
			...
			array(
				...
				'aria-label' => '',
				'type' => 'group',
				'instructions' => 'Create a map that lists posts beside it, which will cause an effect to happen when those posts are hovered over. See <a href="https://wpmaps-docs.mapster.me/pro-features/specialty-maps/listing-page-map" target="_blank">the documentation for help.</a> <span class="mapster-pro-text"> Available in <a href="https://wpmaps.mapster.me/pro">Mapster Pro</a>.</span>',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
