...
* Fix to distance sorting when category list control enabled
...
* Freemius update
= 1.10.0 =
* Fix for zooming on custom search filter
* Fix for multiple image maps
* Adding cursor effect on hover
* Freemius update
= 1.9.0 =
= 1.8.0 =
